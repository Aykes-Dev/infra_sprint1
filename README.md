...
```
14. В директории /etc/systemd/system/ создайте файл gunicorn.service и откройте его в Nano/Vim(Советую,мой любимый, даже если не сможете выйти с негоЮ то найдете кучу мемов):
```
...
```
23. Через редактор Nano/Vim(советую) откройте файл конфигурации веб-сервера:
```
